...
**Yellow Store 프로젝트에서는 마이크로서비스 아키텍처를 채택하고 있어 비대칭키 방식(RSA256)을 사용하는 것을 권장합니다.** 성능보다는 보안성과 분산 환경에서의 키 관리 편의성이 더 중요하기 때문입니다.

---

다음 포스트에서는 **Kafka와 RabbitMQ의 동작 차이**에 대해 다루겠습니다. 두 메시지 브로커의 아키텍처와 사용 시나리오를 비교해보겠습니다. 많은 관심 부탁드립니다! 📨
